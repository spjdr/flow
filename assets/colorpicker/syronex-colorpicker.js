...
(function($) {
  $.fn.colorPicker = function($$options) {
    ...
    return this.each(function() {
      ...
      o.defaultIndex = 0;
      for (var j in o.color) {
        if (o.defaultColor == o.color[j]) {
            o.defaultIndex = parseInt(j);        
        }
      }
      
      var $$oldIndex = typeof(o.defaultIndex)=='number' ? o.defaultIndex : -1;
      
      var _html = "";
      for(i=0;i<o.color.length;i++){
	_html += '<div style="background-color:'+o.color[i]+';"></div>';
	if($$oldIndex==-1 && o.defaultIndex==o.color[i]) $$oldIndex = i;
      }
