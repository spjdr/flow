...
<flow xmlns="http://spjdr.dk/flow/flowxml" xml-version="11071901" title="<?php echo $flow->title ?>" id="http://spjdr.dk/flow/<?php echo $flow->uri ?>.xml" data-updated="<?php echo strftime('%FT%T%z',time()) ?>"> <!--Tidszone og sommertid?-->
...
<?php 			endif; ?>
			...
			<tags>
<?php 			echo ($event->cache != '' ? "\t\t\t\t".$event->tag('xml',$flow->uri,$tags)."\n" : '') ?>
			</tags>
		</event>
<?php 	endforeach; ?>
	</stream>
