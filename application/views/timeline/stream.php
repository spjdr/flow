...
<div class="days" style="width: <?php echo $width ?>px">
<?php foreach($flow['range'] as $i=>$day): ?>
...
<!-- -->
<ul class="stream clearfix" data-stream='{"id": "<?php echo $sid ?>"}' style="width: <?php echo $width ?>px; height: <?php echo 47*max($stream['ongoing'],2) ?>px; background-color: <?php echo $stream['alpha'] ?>">
